// Hassan family demo fixtures. Imported only behind `import.meta.env.DEV` from src/App.jsx.
// Production bundles must contain zero "Hassan" substrings (Phase 1 SEC-08 gate).
...
export const DEFAULT_RENEWAL_PLANS = {
  'UAE Passport': [
